	...
	<table id="factura_head">
		<tr>
			<td class="logo_factura">
				<div>
					<img src="img/logo.png" alt="CODESYS LOGO" height="250px">
				</div>
			</td>
			<td class="info_empresa">
				<div>
					<span class="h2">SISTEMA VENTA / INVENTARIO CODESYS</span>
					<p>Carrt. Entrada Presa de Taveras, Las Canas Abajo</p>
					<p>Teléfono: +1 (809) 371 - 3192</p>
					<p>Email: codesys.inf@gmail.com</p>
				</div>
			</td>
