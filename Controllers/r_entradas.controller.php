...
$sql = "SELECT ent.ID_Entrada, prod.Cod_Producto, prod.Nombre as Nombre_Prod, DATE_FORMAT(ent.Fecha, '%d/%m/%Y a las %H%:%i% %p') AS Fecha_New, ent.Cantidad, ent.Precio_Unitario, u.Usuario, u.Nombre
