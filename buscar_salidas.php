<?php 
    ...
    if(!empty($_REQUEST['fecha_de']) && !empty($_REQUEST['fecha_a'])){
        ...
        if($fecha_de > $fecha_a){
            ...
            $where = "Fecha_Salida LIKE '$fecha_de%'";
            $buscar = "fecha_de=$fecha_de&fecha_a=$fecha_a";
        }else{
            $f_de = $fecha_de.' 00:00:00';
            $f_a = $fecha_a.' 23:59:59';
            $where = "Fecha_Salida BETWEEN '$f_de' AND '$f_a'";
            $buscar = "fecha_de=$fecha_de&fecha_a=$fecha_a";
        }
    }
    include_once("Include/plantilla_Cabeza.php");
    include("Controllers/u_buscarSalida.controller.php");
...
<section id="container">
    ...
    <div>
        ...
        <form method="GET" action="buscar_salidas.php" class="form_search_date">
            <label>De: </label>
    ...
    <table>
        ...
        <tr>
            <td><?= $mostrar['ID_Detalle_Salida']; ?></td>
            <td><?= $mostrar['Cod_Fact']; ?></td>
