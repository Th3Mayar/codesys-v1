...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-05-2023 a las 23:54:50
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `registrar_compra` (`id_proveedor` INT, `usuario_id` INT, `id_producto` INT, `cantidad_comprada` INT, `num_comprobante` VARCHAR(50), `precio` DECIMAL(11,2), `costo` DECIMAL(11,2), `total` DECIMAL(11,2))   BEGIN
          DECLARE cantidad_actual int;

          SELECT Cantidad INTO cantidad_actual FROM t_producto WHERE Cod_Producto = id_producto;

          UPDATE t_producto SET Cantidad = cantidad_actual + cantidad_comprada WHERE Cod_Producto = id_producto;

          INSERT INTO t_compra (Cod_Producto, Cantidad) VALUES (id_producto, cantidad_comprada);

          SELECT 'La compra ha sido registrada exitosamente.' AS mensaje;
    END$$
...
(1184, 'Cover de iphone x', 'Cover de celular', 2, '386.67', 120, '2023-04-24 17:30:39', '60', 'img_2ab29740282d2c2e86875a0916ba126d.jpg', 35, 1, 1),
(1962, 'Iphone x', 'Celular de Apple, IOS 13.5.1', 1, '13500.00', 160, '2023-04-24 17:30:39', '10002', 'iphone_x.PNG', 38, 1, 2),
...
CREATE TABLE `t_venta_credito` (
  ...
  `Total_Factura` decimal(11,2) NOT NULL,
  `ID_Estado` int(11) NOT NULL,
...
ALTER TABLE `t_venta_credito`
  ...
  ADD KEY `FK_codigo_cliente_credito` (`ID_Cliente`),
  ADD KEY `FK_codigo_factura_credito` (`ID_Factura`),
  ADD KEY `FK_codigo_estado_credito` (`ID_Estado`);
...
--
ALTER TABLE `t_detalle_fac_almacenada`
  MODIFY `Correlativo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=262;
...
--
ALTER TABLE `t_factura`
  MODIFY `ID_Factura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=191;

--
-- AUTO_INCREMENT de la tabla `t_fact_detalle`
--
ALTER TABLE `t_fact_detalle`
  MODIFY `ID_Fact_Detalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=393;
...
--
ALTER TABLE `t_salida_inventario`
  MODIFY `ID_Detalle_Salida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
