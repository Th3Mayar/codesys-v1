<?php 
    ...
    include("Controllers/r_clientes.controller.php");
...
<section id="container">
    ...
    <a class="btn_new" href="c_clientes.php"><i class="fa-solid fa-user-plus" style="color: #3d3d3d;"></i> Registrar clientes</a>
        <?php } ?>
    <form method="GET" action="buscar_clientes.php" class="form_search">
    ...
    <table>
        ...
        <tr class="row<?= $mostrar['ID_Cliente'];?>">
